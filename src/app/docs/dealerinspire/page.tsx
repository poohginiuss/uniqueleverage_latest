...
import { DealerInspirePage } from "@/components/landing/docs/dealer-inspire-content";
                ...
                <header className="max-lg:hidden sticky top-0 z-50 ">
                    ...
                    >
                        <Breadcrumbs type="button">
                            ...
                            <Breadcrumbs.Item href="#">Dealer Inspire</Breadcrumbs.Item>
                        </Breadcrumbs>
