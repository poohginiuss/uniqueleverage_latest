...
const megaMenuItems: {
...
}[] = [
    {
        title: "Automation",
        items: [
            { title: "Marketplace", shortSubtitle: "Post, update, and manage listings on FBMP.", href: "/", Icon: Stars02 },
            {
                title: "Inventory Pages (VSP)",
                shortSubtitle: "Native scheduling pages built for conversions.",
                href: "/",
                Icon: Monitor04,
            },
            {
                title: "Scheduled Posting",
                shortSubtitle: "Automate your posting schedule.",
                href: "/",
                Icon: PieChart03,
            },
            {
                title: "Performance Analytics",
                shortSubtitle: "Track ROI and optimize campaigns.",
                href: "/",
                Icon: BarLineChart,
            },
        ],
        ...
        items: [
            {
                ...
                subtitle: "Connect inventory from any of our partners like CarsforSale, DealerCenter, and more.",
                shortSubtitle: "Connect inventory from our partners.",
                href: "/docs/integrations",
                Icon: CheckCircleBroken,
            },
            {
                title: "Calendar Integration",
                subtitle: "Sync with Google, Outlook, and Apple Calendar.",
                shortSubtitle: "Sync with your calendar apps.",
                href: "/docs/integrations",
                Icon: MessageSmileSquare,
            },
            {
                title: "Meta Pixel",
                subtitle: "Track conversions and optimize ad performance.",
                shortSubtitle: "Track conversions and optimize ads.",
                href: "/docs/integrations",
                Icon: CurrencyDollarCircle,
            },
            {
                title: "Ad Accounts",
                shortSubtitle: "Connect Facebook and Google ad accounts.",
                href: "/docs/integrations",
                Icon: LineChartUp05,
                badge: (
        ...
        <nav className="px-3 pb-2 md:w-160 md:p-0">
            <div className="flex flex-col overflow-hidden rounded-xl bg-primary shadow-xs ring-1 ring-secondary_alt md:gap-4 md:rounded-2xl md:p-2 md:shadow-lg">
                ...
                <div className="flex flex-col items-start gap-5 bg-secondary px-4 py-5 md:flex-row md:items-center md:gap-3 md:rounded-lg md:px-6 md:py-5">
                    ...
                    <Button color="link-color" size="lg" className="md:ml-auto" href="/schedule-demo" iconLeading={MessageChatCircle}>
                        Book a Demo
                    </Button>
                </div>
            </div>
