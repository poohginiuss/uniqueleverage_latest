...
export const DealerInspirePage = () => {
  const faqs = [
    {
      q: "How do I connect my Dealer Inspire feed?",
      a: "Follow the Dealer Inspire instructions above to set up your feed connection. The process typically takes 10-15 minutes."
    },
    {
      q: "What information does Dealer Inspire provide?",
      a: "Dealer Inspire provides comprehensive vehicle data including pricing, specifications, images, and availability status."
    },
    {
      q: "How often does Dealer Inspire sync?",
      a: "Dealer Inspire feeds sync automatically every 2-4 hours to ensure your inventory is always up-to-date."
    },
    {
      q: "Can I connect multiple Dealer Inspire accounts?",
      a: "Yes, you can connect multiple Dealer Inspire accounts if you manage inventory for multiple dealerships."
    },
    {
      q: "What if I have issues with my Dealer Inspire connection?",
      a: "Contact our support team and we'll help troubleshoot any connection issues with your Dealer Inspire feed."
    }
  ];
        ...
        <div className="size-full text-tertiary">
          ...
          <div className="mb-10">
            ...
            <p className="typography mt-3 max-w-3xl text-base whitespace-pre-line">
              Connect your Dealer Inspire inventory feed to sync vehicles automatically.
            </p>
          </div>
          ...
          {/* Send Feed Request */}
          <Section id="send-request" title="How to send a feed request?">
            <p className="mb-6">Review the information below and click to send the email.</p>
            <FeedRequestPanel providerKey="dealerinspire" />
          </Section>
        ...
        <div className="flex flex-col max-h-[calc(100vh-7rem)] pb-8">
          ...
          <nav className="mt-4">
            <ol className="flex flex-col gap-2 border-l border-secondary pl-3">
              {[
                { id: "send-request", label: "How to send a feed request?" },
                { id: "faqs", label: "FAQs" },
              ].map((t) => (
                <li key={t.id}>
