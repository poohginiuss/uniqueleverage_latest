...
export const AutoRaptorPage = () => {
  const faqs = [
    {
      q: "How do I connect my AutoRaptor feed?",
      a: "Follow the AutoRaptor instructions above to set up your feed connection. The process typically takes 10-15 minutes."
    },
    {
      q: "What information does AutoRaptor provide?",
      a: "AutoRaptor provides comprehensive vehicle data including pricing, specifications, images, and availability status."
    },
    {
      q: "How often does AutoRaptor sync?",
      a: "AutoRaptor feeds sync automatically every 2-4 hours to ensure your inventory is always up-to-date."
    },
    {
      q: "Can I connect multiple AutoRaptor accounts?",
      a: "Yes, you can connect multiple AutoRaptor accounts if you manage inventory for multiple dealerships."
    },
    {
      q: "What if I have issues with my AutoRaptor connection?",
      a: "Contact our support team and we'll help troubleshoot any connection issues with your AutoRaptor feed."
    }
  ];
        ...
        <div className="size-full text-tertiary">
          ...
          <div className="mb-10">
            ...
            <p className="typography mt-3 max-w-3xl text-base whitespace-pre-line">
              Connect your AutoRaptor inventory feed to sync vehicles automatically.
            </p>
          </div>
          ...
          <Section id="send-feed-request" title="How to send a feed request?">
            <div className="mt-6 space-y-4">
              ...
              <FeedRequestPanel providerKey="autoraptor" />
            </div>
          </Section>
