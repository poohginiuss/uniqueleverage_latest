...
export const TrailerOpsPage = () => {
  const faqs = [
    {
      q: "How do I connect my TrailerOps feed?",
      a: "Follow the TrailerOps instructions above to set up your feed connection. The process typically takes 10-15 minutes."
    },
    {
      q: "What information does TrailerOps provide?",
      a: "TrailerOps provides comprehensive trailer data including pricing, specifications, images, and availability status."
    },
    {
      q: "How often does TrailerOps sync?",
      a: "TrailerOps feeds sync automatically every 2-4 hours to ensure your inventory is always up-to-date."
    },
    {
      q: "Can I connect multiple TrailerOps accounts?",
      a: "Yes, you can connect multiple TrailerOps accounts if you manage inventory for multiple dealerships."
    },
    {
      q: "What if I have issues with my TrailerOps connection?",
      a: "Contact our support team and we'll help troubleshoot any connection issues with your TrailerOps feed."
    }
  ];
        ...
        <div className="size-full text-tertiary">
          ...
          <div className="mb-10">
            ...
            <p className="typography mt-3 max-w-3xl text-base whitespace-pre-line">
              Connect your TrailerOps inventory feed to sync trailers automatically.
            </p>
          </div>
          ...
          <Section id="send-feed-request" title="How to send a feed request?">
            <div className="mt-6 space-y-4">
              ...
              <FeedRequestPanel providerKey="trailerops" />
            </div>
          </Section>
