...
export const DealersLinkPage = () => {
  const faqs = [
    {
      q: "How do I connect my Dealers Link feed?",
      a: "Follow the Dealers Link instructions above to set up your feed connection. The process typically takes 10-15 minutes."
    },
    {
      q: "What information does Dealers Link provide?",
      a: "Dealers Link provides comprehensive vehicle data including pricing, specifications, images, and availability status."
    },
    {
      q: "How often does Dealers Link sync?",
      a: "Dealers Link feeds sync automatically every 2-4 hours to ensure your inventory is always up-to-date."
    },
    {
      q: "Can I connect multiple Dealers Link accounts?",
      a: "Yes, you can connect multiple Dealers Link accounts if you manage inventory for multiple dealerships."
    },
    {
      q: "What if I have issues with my Dealers Link connection?",
      a: "Contact our support team and we'll help troubleshoot any connection issues with your Dealers Link feed."
    }
  ];
        ...
        <div className="size-full text-tertiary">
          ...
          <div className="mb-10">
            ...
            <p className="typography mt-3 max-w-3xl text-base whitespace-pre-line">
              Connect your Dealers Link inventory feed to sync vehicles automatically.
            </p>
          </div>
          ...
          <Section id="send-request" title="How to send a feed request?">
            ...
            <FeedRequestPanel providerKey="dealerslink" />
          </Section>
