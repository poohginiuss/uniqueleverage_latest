...
import { UntitledLogo } from "@/components/foundations/logo/untitledui-logo-homepage";
...
const footerNavItems = [
    ...
    { label: "Privacy Policy", href: "https://uniqueleverage.com/privacy-policy" },
    { label: "Terms of Service", href: "https://uniqueleverage.com/terms-of-service" },
    { label: "Cookie settings", href: "https://uniqueleverage.com/cookie-policy" },
];
