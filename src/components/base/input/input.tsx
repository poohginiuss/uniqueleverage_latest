    ...
    return (
        ...
        >
            ...
            <AriaInput
                ...
                className={cx(
                    "m-0 w-full bg-transparent text-base md:text-sm text-primary ring-0 outline-hidden placeholder:text-placeholder autofill:rounded-lg autofill:text-primary",
